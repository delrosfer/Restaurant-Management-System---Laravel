                ...
                <div class="col-md-3">
                    <div class="card" style="width: 15rem; margin-bottom: 2rem;">
                      ...
                      <div class="card-body">
                        ...
                        <a href="{{route('admin.removeItem', ['id'=>$item->id])}}" class="btn" style="float:right;"><i class="fas fa-trash-alt" ></i> Delete</a>
                        <a href="{{route('admin.editItem', ['id'=>$item->id])}}" class="btn" style="float: left;"><i class="fas fa-edit"></i> Edit</a>
                      </div>
                    </div>
                </div>
                @endforeach
